...
object NegatumGraphs {
  import de.sciss.synth._
  import ugen._

  def g1_51_4456(amp: Float): Unit = {
    NegatumIn()
    val lFDNoise1_0     = LFDNoise1.ar(215.77258)
    val freq_0          = Protect(0.22157374, 10.0, 20000.0, false)
    val width_0         = Protect(17.764212, 0.0, 1.0, false)
    ...
    val in_0            = Protect(31.17988, -inf, inf, true)
    val c_0             = AllpassN.ar(in_0, maxDelayTime = 6.700392, delayTime = 6.700392,
      decayTime = decayTime_0)
    val min_5           = c_0 min min_3
    val freq_1          = Protect(min_5, 0.01, 20000.0, false)
    val iphase_0        = Protect(31.17988, 0.0, 1.0, false)
    ...
    val freq_2          = Protect(min_14, 0.01, 20000.0, false)
    val iphase_1        = Protect(a_0, 0.0, 1.0, false)
    val width_1         = Protect(min_15, 0.0, 1.0, false)
    ...
    val in_3            = Protect(quadC, -inf, inf, true)
    val maxDelayTime_0  = Protect(min_47, 0.0, 20.0, false)
    val protect_0       = Protect(min_51, 0.0, inf, false)
    ...
    val freq_5          = Protect(lFCub_1, -inf, inf, false)
    val xi_2            = Protect(min_52, -inf, inf, false)
    val linCongL_0      = LinCongL.ar(freq = freq_5, a = 3.130919E-4, c = 0.008044177, m = minus,
      xi = xi_2)
    val freq_6          = Protect(linCongL_0, -inf, inf, false)
    val xi_3            = Protect(combL, -inf, inf, false)
    val linCongL_1      = LinCongL.ar(freq = freq_6, a = a_1, c = c_0, m = 754.3841, xi = xi_3)
    val yi_0            = LFDNoise0.ar(97.30713)
    val freq_7          = Protect(quadL, 0.01, 20000.0, false)
    val lFSaw_0         = LFSaw.ar(freq = freq_7, iphase = 0.008044177)
    val freq_8          = Protect(linCongL_1, -inf, inf, false)
    val xi_4            = Protect(lFSaw_0, -inf, inf, false)
    ...
    val in_4            = Protect(min_59, -inf, inf, true)
    val delay2          = Delay2.ar(in_4)
    val xi_5            = Protect(delay2, -inf, inf, false)
    val yi_1            = Protect(gbmanL_0, -inf, inf, false)
    val standardL       = StandardL.ar(freq = varSaw, k = k_1, xi = xi_5, yi = yi_1)
    val freq_9          = Protect(min_43, 0.01, 20000.0, false)
    val iphase_3        = Protect(standardL, -1.0, 1.0, false)
    ...
    val xi_6            = Protect(min_30, -inf, inf, false)
    val yi_2            = Protect(min_57, -inf, inf, false)
    val tailLevel       = StandardN.ar(freq = freq_10, k = k_0, xi = xi_6, yi = yi_2)
    val min_63          = min_25 min tailLevel
    val in_5            = Protect(min_63, -inf, inf, true)
    ...
    val in_6            = Protect(freq_10, -inf, inf, true)
    val timeUp_0        = Protect(min_54, 0.0, 30.0, false)
    val timeDown_0      = Protect(minus, 0.0, 30.0, false)
    ...
    val coeff_0         = Protect(318.76187, 0.8, 0.99, false)
    val leakDC          = LeakDC.ar(17.764212, coeff = coeff_0)
    val in_7            = Protect(leakDC, -inf, inf, true)
    val release_1       = Protect(-9.10621, 0.0, 30.0, false)
    val decay2_1        = Decay2.ar(in_7, attack = 0.4027743, release = release_1)
    val in_8            = Protect(min_80, -inf, inf, true)
    val timeUp_1        = Protect(decay2_1, 0.0, 30.0, false)
    val timeDown_1      = Protect(min_79, 0.0, 30.0, false)
    ...
    val in_9            = Protect(min_82, -inf, inf, true)
    val freq_11         = Protect(3.7802913E-4, 10.0, 20000.0, false)
    val a_2             = BPF.ar(in_9, freq = freq_11, rq = 97.30713)
    val min_86          = min_70 min min_61
    val b_0             = min_86 min min_25
    val freq_12         = Protect(min_6, -inf, inf, false)
    val x0              = Protect(min_86, -inf, inf, false)
    ...
    val freq_13         = Protect(min_86, -inf, inf, false)
    val a_3             = Protect(min_75, -3.0, 3.0, false)
    val b_1             = Protect(bitOr, 0.5, 1.5, false)
    val c_3             = Protect(lFSaw_1, 0.5, 1.5, false)
    val xi_7            = Protect(min_80, -inf, inf, false)
    val yi_3            = Protect(min_100, -inf, inf, false)
    val latoocarfianL_0 = LatoocarfianL.ar(freq = freq_13, a = a_3, b = b_1, c = c_3, d = 31.17988,
      xi = xi_7, yi = yi_3)
    val freq_14         = Protect(latoocarfianL_0, -inf, inf, false)
    val a_4             = Protect(min_96, -3.0, 3.0, false)
    val b_2             = Protect(tailLevel, 0.5, 1.5, false)
    val c_4             = Protect(min_97, 0.5, 1.5, false)
    val xi_8            = Protect(min_85, -inf, inf, false)
    val yi_4            = Protect(min_35, -inf, inf, false)
    val latoocarfianL_1 = LatoocarfianL.ar(freq = freq_14, a = a_4, b = b_2, c = c_4, d = d, xi = xi_8,
      yi = yi_4)
    val dur             = Protect(a_1, 5.0E-5, 100.0, false)
    val width_2         = Protect(latoocarfianL_1, 0.0, 1.0, false)
    val phase           = Protect(lFSaw_1, 0.0, 1.0, false)
    val lFGauss         = LFGauss.ar(dur = dur, width = width_2, phase = phase, loop = loop,
      doneAction = doNothing)
    val in_10           = Protect(241.16264, -inf, inf, true)
    val time_0          = Protect(min_64, 0.0, 30.0, false)
    ...
    val freq_15         = Protect(min_85, -inf, inf, false)
    val xi_9            = Protect(min_26, -inf, inf, false)
    val yi_5            = Protect(min_103, -inf, inf, false)
    ...
    val in_11           = Protect(min_120, -inf, inf, true)
    val maxDelayTime_1  = Protect(min_56, 0.0, 20.0, false)
    val protect_1       = Protect(c_0, 0.0, inf, false)
    ...
    val in_12           = Protect(min_109, -inf, inf, true)
    val winSize         = Protect(min_66, 0.001, 2.0, false)
    val pitchRatio      = Protect(7.9544034, 0.0, 4.0, false)
    val pitchDispersion = Protect(gbmanN, 0.0, 1.0, false)
    val protect_2       = Protect(min_121, 0.0, inf, false)
    ...
    val in_13           = Protect(0.0, -inf, inf, true)
    val maxDelayTime_2  = Protect(min_12, 0.0, 20.0, false)
    val protect_3       = Protect(min_128, 0.0, inf, false)
    ...
    val in_14           = Protect(35.973347, -inf, inf, true)
    val time_1          = Protect(lFSaw_1, 0.0, 30.0, false)
    ...
    val in_15           = Protect(min_136, -inf, inf, true)
    val freq_16         = Protect(min_4, 10.0, 20000.0, false)
    val rq_0            = Protect(min_7, 0.01, 100.0, false)
    val bPF             = BPF.ar(in_15, freq = freq_16, rq = rq_0)
    val min_138         = min_77 min min_58
    val in_16           = Protect(min_103, -inf, inf, true)
    ...
    val in_17           = Protect(min_145, -inf, inf, true)
    val lPF_1           = LPF.ar(in_17, freq = 97.30713)
    val freq_17         = Protect(min_104, -inf, inf, false)
    val lFDNoise1_1     = LFDNoise1.ar(freq_17)
    val min_146         = min_145 min lFCub_0
    val in_18           = Protect(min_58, -inf, inf, true)
    val coeff_1         = Protect(min_146, -1.0, 1.0, false)
    ...
    val in_19           = Protect(latoocarfianL_1, -inf, inf, true)
    val protect_4       = Protect(3.7802913E-4, 0.55, inf, false)
    val revTime         = Protect(c_2, 0.0, 100.0, false)
    val damping         = Protect(min_64, 0.0, 1.0, false)
    val spread          = Protect(min_144, 0.0, 43.0, false)
    val maxRoomSize     = Protect(min_67, 0.55, 300.0, false)
  ...
  def g1_51_4533(amp: Float) = {
    NegatumIn()
    val width_0         = Protect(23.773453, 0.0, 1.0, false)
    val pulse           = Pulse.ar(freq = 23.773453, width = width_0)
    val freq_0          = Protect(pulse, -inf, inf, false)
    val lFDNoise1_0     = LFDNoise1.ar(freq_0)
    val in_0            = Protect(lFDNoise1_0, -inf, inf, true)
    ...
    val in_2            = Protect(pulse, -inf, inf, true)
    val a_0             = Decay.ar(in_2, time = 23.773453)
    val in_3            = Protect(a_0, -inf, inf, true)
    val maxDelayTime_0  = Protect(min_1, 0.0, 20.0, false)
    val protect_0       = Protect(min_16, 0.0, inf, false)
    val delayTime_0     = protect_0 min maxDelayTime_0
    val delayC          = DelayC.ar(in_3, maxDelayTime = maxDelayTime_0, delayTime = delayTime_0)
    val neq             = delayC sig_!= -151.92877
    val dur_0           = Protect(neq, 5.0E-5, 100.0, false)
    val width_1         = Protect(a_0, 0.0, 1.0, false)
    val phase           = Protect(pulse, 0.0, 1.0, false)
    val lFGauss         = LFGauss.ar(dur = dur_0, width = width_1, phase = phase, loop = 6.700392,
      doneAction = doNothing)
    val yi_0            = Protect(lFGauss, -inf, inf, false)
    val standardL_0     = StandardL.ar(freq = -0.0014333398, k = -260.23517, xi = 0.2771094, yi = yi_0)
    val in_4            = Protect(-0.0014333398, -inf, inf, true)
    val delay2          = Delay2.ar(in_4)
    val min_17          = standardL_0 min delay2
    val in_5            = Protect(min_17, -inf, inf, true)
    val lPZ1_0          = LPZ1.ar(in_5)
    val in_6            = Protect(lPZ1_0, -inf, inf, true)
    val hPZ1_0          = HPZ1.ar(in_6)
    val min_18          = hPZ1_0 min 23.773453
    val freq_2          = Protect(min_18, -inf, inf, false)
    ...
    val freq_3          = Protect(b_0, -inf, inf, false)
    val freq_4          = LFDClipNoise.ar(freq_3)
    val length          = Protect(freq_4, 1.0, 44100.0, false)
    ...
    val in_8            = Protect(8541.102, -inf, inf, true)
    val freq_5          = Protect(min_39, 10.0, 20000.0, false)
    val radius_0        = Protect(min_25, 0.0, 1.0, false)
    ...
    val in_9            = Protect(min_15, -inf, inf, true)
    val maxDelayTime_1  = Protect(min_14, 0.0, 20.0, false)
    val protect_1       = Protect(min_41, 0.0, inf, false)
    val delayTime_1     = protect_1 min maxDelayTime_1
    val a_1             = CombN.ar(in_9, maxDelayTime = maxDelayTime_1, delayTime = delayTime_1,
      decayTime = decayTime_0)
    val in_10           = Protect(min_28, -inf, inf, true)
    val freq_6          = Protect(min_23, 10.0, 20000.0, false)
    val radius_1        = Protect(min_24, 0.0, 1.0, false)
    ...
    val in_11           = Protect(-151.92877, -inf, inf, true)
    val maxDelayTime_2  = Protect(min_23, 0.0, 20.0, false)
    val protect_2       = Protect(min_46, 0.0, inf, false)
    val delayTime_2     = protect_2 min maxDelayTime_2
    val a_2             = DelayN.ar(in_11, maxDelayTime = maxDelayTime_2, delayTime = delayTime_2)
    val freq_7          = Protect(min_1, -inf, inf, false)
    val x0              = Protect(min_20, -inf, inf, false)
    val x1_0            = Protect(min_14, -inf, inf, false)
    ...
    val in_16           = Protect(0.108262725, -inf, inf, true)
    val maxDelayTime_3  = Protect(min_75, 0.0, 20.0, false)
    val protect_3       = Protect(earlyRefLevel, 0.0, inf, false)
    ...
    val in_17           = Protect(0.029109515, -inf, inf, true)
    val maxDelayTime_4  = Protect(min_77, 0.0, 20.0, false)
    val protect_4       = Protect(min_85, 0.0, inf, false)
    ...
    val freq_11         = Protect(min_51, -inf, inf, false)
    val lFDNoise1_2     = LFDNoise1.ar(freq_11)
    val in_18           = Protect(henonL, -inf, inf, true)
    val coeff_0         = Protect(13.775431, -0.999, 0.999, false)
    val onePole         = OnePole.ar(in_18, coeff = coeff_0)
    val min_88          = min_39 min min_79
    val min_89          = min_88 min min_24
    val in_19           = Protect(combN, -inf, inf, true)
    val bRZ2            = BRZ2.ar(in_19)
    val min_90          = min_68 min henonL
    val in_20           = Protect(henonL, -inf, inf, true)
    val freq_12         = Protect(min_90, 10.0, 20000.0, false)
    val rq_1            = Protect(min_6, 0.01, 100.0, false)
    ...
    val in_21           = Protect(a_4, -inf, inf, true)
    val freq_13         = Protect(min_60, 10.0, 20000.0, false)
    val rLPF            = RLPF.ar(in_21, freq = freq_13, rq = 1.0)
    val min_93          = rLPF min min_69
    val clip2           = -7595.3853 clip2 b_1
    val in_22           = Protect(-7595.3853, -inf, inf, true)
    val coeff_1         = Protect(ramp, -1.0, 1.0, false)
    val tailLevel       = OneZero.ar(in_22, coeff = coeff_1)
    val in_23           = Protect(min_13, -inf, inf, true)
    val protect_5       = Protect(min_93, 0.55, inf, false)
    val revTime         = Protect(-260.23517, 0.0, 100.0, false)
    val damping         = Protect(combN, 0.0, 1.0, false)
    val spread          = Protect(1225.153, 0.0, 43.0, false)
    val maxRoomSize     = Protect(min_51, 0.55, 300.0, false)
    ...
    val in_24           = Protect(min_14, -inf, inf, true)
    val winSize         = Protect(henonL, 0.001, 2.0, false)
    val pitchRatio      = Protect(onePole, 0.0, 4.0, false)
    val protect_6       = Protect(min_95, 0.0, inf, false)
    ...
    val freq_14         = Protect(min_78, -inf, inf, false)
    val x1_1            = Protect(min_94, -inf, inf, false)
    ...
    val xi_2            = Protect(b_0, -inf, inf, false)
    val linCongN        = LinCongN.ar(freq = freq_4, a = a_4, c = c_1, m = m, xi = xi_2)
    val freq_15         = Protect(min_74, -inf, inf, false)
    val xi_3            = Protect(linCongN, -inf, inf, false)
    val yi_1            = Protect(min_12, -inf, inf, false)
    val gbmanL          = GbmanL.ar(freq = freq_15, xi = xi_3, yi = yi_1)
    val in_25           = Protect(gbmanL, -inf, inf, true)
    val lPZ1_1          = LPZ1.ar(in_25)
    val in_26           = Protect(standardL_1, -inf, inf, true)
    val radius_2        = Protect(bRF, 0.0, 1.0, false)
    ...
    val freq_16         = Protect(min_51, 0.01, 20000.0, false)
    val iphase_1        = Protect(varSaw, 0.0, 1.0, false)
    val lFPar           = LFPar.ar(freq = freq_16, iphase = iphase_1)
    val hypotx          = lFPar hypotx min_76
    val min_101         = min_73 min min_29
    val min_102         = min_75 min min_20
    val freq_17         = Protect(min_38, 10.0, 20000.0, false)
    val saw_1           = Saw.ar(freq_17)
    val min_103         = min_89 min sumsqr
    val iphase_2        = Protect(pulse, 0.0, 1.0, false)
    val lFCub           = LFCub.ar(freq = 23.773453, iphase = iphase_2)
    val min_104         = in_7 min 23.773453
    val in_27           = Protect(-9136.164, -inf, inf, true)
